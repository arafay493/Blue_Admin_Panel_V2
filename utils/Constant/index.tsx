...
export const Footertext: string = "Copyright 2024 © PSO Blue";
...
export const NotificationSenderTitle: string = "Notification Sender";
export const ScheduleNotificationTitle: string = "Schedule Notification";
...
export const CustomerHeading: string = "Customer";
export const GeneralSetupHeading: string = "General Setup";
export const DiscountAndVouchers: string = "Discount And Vouchers";
export const AddItemTypeHeading: string = "Add Item Type";
export const AddItemLocationHeading: string = "Add Item Location";
export const InfluencerListHeading: string = "Influencer List";
export const ReferrersHeading: string = " Referrers";
export const CreateMasterConsignmentHeading: string =
  "Create Master Consignment";
export const MasterConsignmentListHeading: string = "Master Consignment List";
export const ViewDocumentHeading: string = "View Document";
export const AddMasterItemHeading: string = "Add Master Item";
export const MasterBatchHeading: string = "Master Batch";
export const BatchStatusReportHeading: string = "Batch Status Report";
export const CylinderStatusHeading: string = "Cylinder Status";
export const AdminstratorHeading: string = "Administrator";
export const PaymentsHeading: string = "Payments";
...
// dashboard
export const Default_Util: string = "Admin Dashboard";
...
export const CustomerListHeading: string = "Customer List";
...
export const CustomerList: string = "Customer List";
export const CreateUserHeading: string = "Create User Type";
export const CreateUserFormHeading: string = "Create User";
export const ChangePasswordHeading: string = "Change Password";
export const CashReceivablesHeading: string = "Cash Receivables";
export const ReceivablesConsHeading: string = "Received Cash Consignments";
export const UnreceivablesConsHeading: string = "Pending Cash Consignments";
export const UserAccessHeading: string = "User Access";
export const UserListHeading: string = "User List";
export const otp: string = "OTP Codes";
export const RegionManagementHeading: string = "Add Customer Area";
export const AllTransactionList: string = "All Transactions";
export const WarningCustomersList: string = "Warning Customer";
export const PaymentMethodHeading: string = "Payment Methods";
export const RegisterContractorHeading: string = "Register Contractor";
export const RegisterDriverHeading: string = "Register Driver";
export const RegisterVehicleHeading: string = "Register Vehicle";
export const RegisterLocationHeading: string = "Register Location";
export const ContractorListHeading: string = "Contractor List";
export const HolidayHeading: string = "Holiday Management";
export const RegionPricing: string = "Region Pricing";
export const CustomerOrders: string = "Customer Orders";
export const OrderDelivery: string = "Order Delivery";
export const DiscountVouchers: string = "Discount Vouchers";
export const DepositHeading: string = "Deposits";
export const CashManagementHeading: string = "Cash Management";
export const BankAccountHeading: string = "Bank Account";
export const DepositListHeading: string = "Deposit List";
export const DepositFormHeading: string = "Deposit Form";
export const BankAccountFormHeading: string = "Bank Account ";
export const FilledMovementHeading: string = "Filled Movement";
export const EmptyMovementHeading: string = "Empty Movement";
export const InOutHeading: string = "In/Out Filled";
export const InOutEmptyHeading: string = "In/Out Empty";
export const TransferFilledHeading: string = " Transfer Filled List";
export const TransferEmptyHeading: string = "Transfer Empty List";
export const MasterItems: string = "Master Items";
export const InfluencerTitle: string = "Influencer";
export const MasterConsignemntTitle: string = "Master Consignemnt";
export const OrdersLocation: string = "Orders Location";
export const OrderConsignment: string = "Order Consignment";
export const RegionalPricing: string = "Regional Pricing";
export const SecurityDeposit: string = "Security Deposit";
export const TrackDriverLocationHeading: string = "Track Driver Location";
export const AllOrderReports: string = "Order Reports";
export const FeedbackList: string = "Feedback List";
